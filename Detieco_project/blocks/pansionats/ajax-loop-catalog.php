...
if($post_type->post_type == 'cities_kliniki') {
...
if($post_type->post_type == 'countries_kliniki') {
    $args['meta_query'] = array(
        array(
            'key' => 'countries_field',
            'value' => $id,
...
if($wp_query->have_posts()): ?>
                <?php $i = 0; while($wp_query->have_posts()): $wp_query->the_post(); ?>
                    ...
                    ?>
                    <div class="house-item<?php echo ($i == 5 && $counts != $nextpage) ? ' houses-last' : ''; ?>">
                        ...
                        <div class="house-item-content">
                            ...
                            <div class="house-info-text clearfix">
                                ...
                                <div class="house-info-rate">
                                    ...
                                    $test = str_replace('gdrts-state-active', 'gdrts-state-inactive', $test);
                                    print_r($test);
                                    ?>
                                </div>
                            </div>

...
if(is_singular('cities_pansionat')) {
...
if(is_singular('countries_pansionat')) {
    $args['meta_query'] = array(
        array(
            'key' => 'countries_field',
            'value' => $post->ID,
...
<?php if ($post_type == 'cities_pansionat'): ?>
...
<div class="houses">
                ...
                <div class="house-item-image">
                    ...
                    <a href="<?php the_permalink(); ?>">
                        <div class="house-item-image-text">
                            <div class="house-item-image-title">
                                <?php the_title(); ?>
                            </div>
                    ...
                    <div class="house-info-text clearfix">
                        <div class="house-info-marks">
                            <div class="house-info-mark">
                                ...
                                <?php $img = wp_get_attachment_image_url(get_field('chastnie_pansionat', 'options'), 'thumbnail_60x60'); ?>
                                <span class="icon" style="background: url(<?php echo $img; ?>) no-repeat;"></span>
                                <div>
                                    <?php _e('Частное<br />Учреждение', 'base'); ?>
                                </div>
                                <?php elseif($_type == 'gos'): ?>
                                <?php $img = wp_get_attachment_image_url(get_field('gos_pansionat', 'options'), 'thumbnail_60x60'); ?>
                                <span class="icon" style="background: url(<?php echo $img; ?>) no-repeat;"></span>
                                <div>
                                    <?php _e('Гос.<br>Учреждение', 'base'); ?>
                                </div>
                                <?php endif; ?>
                            </div>
                            <?php if($_physical): ?>
    ...
    <div class="text-center">
        ...
        <a href="<?php echo $permalink . '?the_page=' . $page; ?>" data-nextpage="<?php echo $page; ?>" class="button show-more">
            <?php _e('ПОКАЗАТЬ ЕЩЕ', 'base'); ?>
        </a>
    </div>
    <?php endif; ?>

    <?php do_shortcode("[rBlock name=pansionaty_after_more1]"); ?>

</div>
<?php else: ?>
<h3>
    <?php _e('Не найдено', 'base'); ?>
</h3>
